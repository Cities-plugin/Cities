package nl.partytitan.cities.internal.utils.confirmation.obj;

import nl.partytitan.cities.internal.utils.confirmation.ConfirmationUtil;
...
public class ConfirmationBuilder {
    ...
    String title;
    int duration = ConfigUtil.getSettings().getExpirationTime();
    boolean runAsync;
    ...
    public void sendTo(CommandSender sender) {
        ...
        ConfirmationUtil.sendConfirmation(sender, confirmation);
    }
}